...
4. eQTL: cis and trans-eQTL used in the first round of Gibbs sampling.
5. output_results: Here we only uploaded the results predicted using Hi-C data in neurons as an example. And the novel genes were also listed in .xlsx.
